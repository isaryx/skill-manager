...
complete -c skm -n "__fish_skm_needs_command" -f -a "repo" -d 'Manage remote skill repositories (GitHub)'
...
complete -c skm -n "__fish_skm_using_subcommand repo; and not __fish_seen_subcommand_from add ls help" -l store -d 'Store root directory (env: SKM_STORE)' -r -F
complete -c skm -n "__fish_skm_using_subcommand repo; and not __fish_seen_subcommand_from add ls help" -l color -d 'When to colorize human output (`auto` respects NO_COLOR)' -r -f -a "auto\t''
always\t''
never\t''"
complete -c skm -n "__fish_skm_using_subcommand repo; and not __fish_seen_subcommand_from add ls help" -s v -l verbose -d 'Enable verbose logging on stderr'
complete -c skm -n "__fish_skm_using_subcommand repo; and not __fish_seen_subcommand_from add ls help" -l json -d 'Emit machine-readable JSON on stdout (`status`, `ls`, `search`, `skill ls`, `skill validate`, `doctor`, `repo ls` only)'
complete -c skm -n "__fish_skm_using_subcommand repo; and not __fish_seen_subcommand_from add ls help" -l dry-run -d 'Preview changes without writing (`sync`, `add-profile`, `remove-profile`, `skill rm`, `destroy` only)'
complete -c skm -n "__fish_skm_using_subcommand repo; and not __fish_seen_subcommand_from add ls help" -s h -l help -d 'Print help'
complete -c skm -n "__fish_skm_using_subcommand repo; and not __fish_seen_subcommand_from add ls help" -f -a "add" -d 'Clone and register a GitHub repository as a skill source'
complete -c skm -n "__fish_skm_using_subcommand repo; and not __fish_seen_subcommand_from add ls help" -f -a "ls" -d 'List registered remote repositories'
complete -c skm -n "__fish_skm_using_subcommand repo; and not __fish_seen_subcommand_from add ls help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c skm -n "__fish_skm_using_subcommand repo; and __fish_seen_subcommand_from help" -f -a "add" -d 'Clone and register a GitHub repository as a skill source'
...
complete -c skm -n "__fish_skm_using_subcommand help; and not __fish_seen_subcommand_from init import profile skill use-profiles add-profile remove-profile use-agents add-agent remove-agent destroy sync status ls scan search doctor repo update help" -f -a "import" -d 'Import a skill directory into the store'
...
complete -c skm -n "__fish_skm_using_subcommand help; and not __fish_seen_subcommand_from init import profile skill use-profiles add-profile remove-profile use-agents add-agent remove-agent destroy sync status ls scan search doctor repo update help" -f -a "repo" -d 'Manage remote skill repositories (GitHub)'
...
complete -c skm -n "__fish_skm_using_subcommand help; and __fish_seen_subcommand_from repo" -f -a "add" -d 'Clone and register a GitHub repository as a skill source'
