...
complete -c skm -n "__fish_skm_using_subcommand init" -l agent -d 'Target agent for this project' -r -f -a "claude-code\t'Claude Code (.claude/skills)'
...
complete -c skm -n "__fish_skm_using_subcommand profile; and not __fish_seen_subcommand_from setup extend ls show rm help" -f -a "extend" -d 'Choose which profiles this one inherits skills from (interactive)'
...
complete -c skm -n "__fish_skm_using_subcommand profile; and __fish_seen_subcommand_from help" -f -a "extend" -d 'Choose which profiles this one inherits skills from (interactive)'
...
complete -c skm -n "__fish_skm_using_subcommand switch-agent" -l agent -d 'Agent to switch to' -r -f -a "claude-code\t'Claude Code (.claude/skills)'
cursor\t'Cursor (.cursor/skills)'
generic\t'Agent Skills (.agents/skills); Codex, Cursor, Gemini CLI, Copilot CLI'
gemini-cli\t'Gemini CLI (.gemini/skills)'
copilot-cli\t'Copilot CLI (.github/skills; ~/.copilot/skills with --user)'"
...
complete -c skm -n "__fish_skm_using_subcommand help; and not __fish_seen_subcommand_from init import profile skill use-profile switch-agent sync status ls scan doctor help" -f -a "import" -d 'Import a skill directory into the store'
...
complete -c skm -n "__fish_skm_using_subcommand help; and not __fish_seen_subcommand_from init import profile skill use-profile switch-agent sync status ls scan doctor help" -f -a "skill" -d 'Manage skills in the store'
...
complete -c skm -n "__fish_skm_using_subcommand help; and not __fish_seen_subcommand_from init import profile skill use-profile switch-agent sync status ls scan doctor help" -f -a "status" -d 'Show agent, active profile, linked skills, and name conflicts'
...
complete -c skm -n "__fish_skm_using_subcommand help; and __fish_seen_subcommand_from profile" -f -a "extend" -d 'Choose which profiles this one inherits skills from (interactive)'
