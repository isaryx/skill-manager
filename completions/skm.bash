_skm() {
    ...
    do
        case "${cmd},${i}" in
            ...
            skm,remove-profile)
                ...
                ;;
            skm,repo)
                cmd="skm__subcmd__repo"
                ;;
            skm,scan)
                cmd="skm__subcmd__scan"
                ;;
            skm,search)
                cmd="skm__subcmd__search"
                ;;
            skm,skill)
            ...
            skm__subcmd__help,remove-profile)
                ...
                ;;
            skm__subcmd__help,repo)
                cmd="skm__subcmd__help__subcmd__repo"
                ;;
            skm__subcmd__help,scan)
                cmd="skm__subcmd__help__subcmd__scan"
                ;;
            skm__subcmd__help,search)
                cmd="skm__subcmd__help__subcmd__search"
                ;;
            ...
            skm__subcmd__help,sync)
                ...
                ;;
            skm__subcmd__help,update)
                cmd="skm__subcmd__help__subcmd__update"
                ;;
            ...
            skm__subcmd__help__subcmd__skill,setup)
                ...
                ;;
            skm__subcmd__help__subcmd__skill,validate)
                cmd="skm__subcmd__help__subcmd__skill__subcmd__validate"
                ;;
            ...
            skm__subcmd__skill,setup)
                ...
                ;;
            skm__subcmd__skill,validate)
                cmd="skm__subcmd__skill__subcmd__validate"
                ;;
            ...
            skm__subcmd__skill__subcmd__help,setup)
                ...
                ;;
            skm__subcmd__skill__subcmd__help,validate)
                cmd="skm__subcmd__skill__subcmd__help__subcmd__validate"
                ;;
            *)
                ;;
        esac
    ...
    case "${cmd}" in
        skm)
            opts="-v -h -V --verbose --store --json --dry-run --color --help --version init import profile skill use-profiles add-profile remove-profile use-agents add-agent remove-agent destroy sync status ls scan search doctor repo update help"
        ...
        skm__subcmd__doctor)
            ...
            ;;
        skm__subcmd__help)
            opts="init import profile skill use-profiles add-profile remove-profile use-agents add-agent remove-agent destroy sync status ls scan search doctor repo update help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        skm__subcmd__help__subcmd__repo)
            ...
            return 0
            ;;
        skm__subcmd__help__subcmd__repo__subcmd__add)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        skm__subcmd__help__subcmd__scan)
            ...
            return 0
            ;;
        skm__subcmd__help__subcmd__search)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        skm__subcmd__help__subcmd__skill__subcmd__setup)
            ...
            return 0
            ;;
        skm__subcmd__help__subcmd__skill__subcmd__validate)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        skm__subcmd__help__subcmd__sync)
            ...
            return 0
            ;;
        skm__subcmd__help__subcmd__update)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        skm__subcmd__help__subcmd__use__subcmd__profiles)
            ...
            ;;
        skm__subcmd__import)
            opts="-v -h --copy --move --as --repo --strict --verbose --store --json --dry-run --color --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        skm__subcmd__repo__subcmd__help__subcmd__add)
            ...
            return 0
            ;;
        skm__subcmd__repo__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        skm__subcmd__repo__subcmd__help__subcmd__ls)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        skm__subcmd__search)
            ...
            ;;
        skm__subcmd__skill)
            opts="-v -h --verbose --store --json --dry-run --color --help ls setup rm validate help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        skm__subcmd__skill__subcmd__help)
            opts="ls setup rm validate help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        skm__subcmd__skill__subcmd__help__subcmd__setup)
            ...
            return 0
            ;;
        skm__subcmd__skill__subcmd__help__subcmd__validate)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        skm__subcmd__skill__subcmd__setup)
            ...
            return 0
            ;;
        skm__subcmd__skill__subcmd__validate)
            opts="-v -h --verbose --store --json --dry-run --color --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        skm__subcmd__status)
            ...
            ;;
        skm__subcmd__sync)
            opts="-u -v -h --user --no-pull --strict --verbose --store --json --dry-run --color --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
