...
**From a release** — download `skm` for your platform from [GitHub Releases](https://github.com/vu.trandaovuong/skill-manager/releases), extract the binary, and put it on your `PATH`.
